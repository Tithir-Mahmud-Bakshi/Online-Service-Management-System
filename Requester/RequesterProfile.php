...
if(isset($_REQUEST['nameupdate'])){
	if($_REQUEST['rName'] == ""){
		$passmsg = '<div class= "alert alert-warning col-sm-6 ml-5 mt-2" role ="alert">Fill All Feilds</div>';
	} else{
    		...
    		<div class="col-sm-6 mt-5"> <!--Start Profile Area 2nd column-->
    			<form action="" method="POST"  class="mx-5">
    				<div class="form-group">
    					...
    					<input type="email" class="form-control" name="rEmail" id="rEmail" readonly> <!--value="<?php echo $rEmail ?>" -->
    				</div>
    				<div class="form-group">
